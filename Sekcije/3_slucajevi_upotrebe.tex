...
\begin{itemize}
    ...
    \item Alternativni tok:
        \begin{itemize}
            ...
            \item 4. Korisnik preskače registraciju kartice pri čemu mu se onemogućava naručivanje vozila dok je ne registruje
        \end{itemize}
    \item Dodatne informacije:
        \begin{itemize}
            \item Uslovi upotrebe su regulisani zakonom. Ne poštovanje tih uslova može dovesti do ukidanja naloga korisnika i daljih sudskih postupaka.
        \end{itemize}
\end{itemize}
